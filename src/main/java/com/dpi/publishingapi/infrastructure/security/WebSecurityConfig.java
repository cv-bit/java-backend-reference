package com.dpi.publishingapi.infrastructure.security;

import com.dpi.publishingapi.infrastructure.exceptions.security.CustomAccessDeniedException;
import com.dpi.publishingapi.infrastructure.exceptions.security.CustomAuthException;
import com.dpi.publishingapi.infrastructure.security.auth.local.UserDetailsServiceImpl;
import com.dpi.publishingapi.infrastructure.security.jwt.AuthEntryPointJwt;
import com.dpi.publishingapi.infrastructure.security.jwt.AuthTokenFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf().disable().cors().and()
                ...
                .authorizeRequests().antMatchers("/auth/**", "/books/all", "/books", "/books/search", "/books/reviews", "/creators/**", "/publishers/**").permitAll(
                )
